...
/**
 * Responsible to facilitate organization in the master-detail pattern flow in the step detail
 */
public interface RecipeDetailStep {

    /**
     * Show the step details
     */
    void show(Recipe recipe, Step step);
